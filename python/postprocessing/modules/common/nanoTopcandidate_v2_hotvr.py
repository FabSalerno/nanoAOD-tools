        ...
        for idx_j0 in range(ngoodjets):
                for idx_j1 in range(idx_j0):
                    ...
                    for idx_hvrj in range(ngoodhvrjets):
                        ...
                        if deltaR(hvrj,j0)<600/hvrj.pt or deltaR(hvrj,j1)<600/hvrj.pt:
                            ntophighpt += 1
                            ...
                            if self.isMC and self.multiscore==0:
                                ...
                                if quark_number(j0=j0, j1=j1, hvrj=hvrj)==1 or quark_number(j0=j0, j1=j1, hvrj=hvrj)==2:
                                    tophigh_truth.append(-1)
                    ...
                    for idx_j2 in range(idx_j1):
                        ...
                        for idx_hvrj in range(ngoodhvrjets):
                            ...
                            if deltaR(hvrj,j0)<600/hvrj.pt or deltaR(hvrj,j1)<600/hvrj.pt or deltaR(hvrj,j1)<600/hvrj.pt:
                                ntophighpt += 1
                                tophigh_idxhvrjet.append(idx_hvrj)
                                tophigh_idxfatjet.append(-1)
                                tophigh_idxjet0.append(idx_j0)
                                ...
                                if self.isMC and self.multiscore==0:
                                    ...
                                    if quark_number(j0=j0, j1=j1, j2=j2, fj=None, hvrj=hvrj)==1 or quark_number(j0=j0, j1=j1, j2=j2, fj=None, hvrj=hvrj)==2:
                                        tophigh_truth.append(-1)
