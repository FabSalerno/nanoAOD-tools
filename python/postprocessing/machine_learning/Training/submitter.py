...
def sub_writer(year, component, inFile_to_open, nev, path_to_pkl):
    f = open("condor.sub", "w")
...
datasets = {'TT_Mtt1000toInf_2018': '/eos/user/f/fsalerno/Data/post_crab/TT_Mtt1000toInf_2018_10000.root'}
year = 2018
for d in datasets:
    #dat = 'root://cms-xrd-global.cern.ch//'+dat
    #outname=dat.split("/")[-1].replace('.root', '_Skim.root')
    final_name = '/eos/user/f/fsalerno/framework/MachineLearning/Training/pkls'+d+'_Skim.root'
    sub_writer(2018, datasets[d], "TT_Mtt1000toInf_2018", -1, final_name)
    #print(d.label)
    print(d)
