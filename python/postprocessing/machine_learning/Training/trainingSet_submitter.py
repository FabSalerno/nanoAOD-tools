...
def sh_writer(year, component, inFile_to_open, nev, path_to_pkl, select_top_over_threshold, thr):
    ...
    if select_top_over_threshold:
        f.write(f"python3 trainingSet.py -year {year} -component {component} -inFile_to_open {inFile_to_open} -nev {nev} -path_to_pkl {path_to_pkl} -select_top_over_threshold -thr {thr}\n")
    else:
        f.write(f"python3 trainingSet.py -year {year} -component {component} -inFile_to_open {inFile_to_open} -nev {nev} -path_to_pkl {path_to_pkl}\n")
...
if year==2018:
    ...
    path_to_training_folder = "/eos/user/f/fsalerno/framework/MachineLearning/Training_PF_2022_1_prova_TROTA_full"
...
for dat in datasets:
    ...
    sh_writer(year=year,
              component=dat,
              inFile_to_open="/eos/user/f/fsalerno/Data/TROTA/topcand/nano_mcRun3_qcd_1500_2000_topcand_TROTA_qcd_1500_2000.root",
              nev=nev,
