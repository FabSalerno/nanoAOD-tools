...
verbose                 = True
path_to_best_hps        = "/eos/user/f/fsalerno/framework/MachineLearning/Grid_search_1/grid_search_models/PF_jets_boosted/best_hps.json"
...
class trainer:
    ...
    def model_builder(self, InputShape_Jet, InputShape_FatJet, InputShape_PFC, InputShape_Top):
        ...
        # Tune parameters for Jet Input Layer #
        z = keras.layers.LSTM(units=self.BestHyperParameters["PFC_units"],
                              activation=self.BestHyperParameters["PFC_activation"],
                              kernel_initializer=self.BestHyperParameters["PFC_kernel_initializer"],
                              dropout=self.BestHyperParameters["PFC_dropout"]
                             )(z)
        ...
        self.model.compile(optimizer=trainer, loss=loss, metrics=[tf.keras.metrics.AUC()]) #AUC   
    ...
    def callbacks(self):
        ...
        early_stop = keras.callbacks.EarlyStopping(monitor= "val_auc", #"val_binary_crossentropy",
        ...
        reduce_LR = keras.callbacks.ReduceLROnPlateau(monitor="val_auc", #"val_binary_crossentropy", #val_auc",
...
metric  = "auc" #"binary_crossentropy"
