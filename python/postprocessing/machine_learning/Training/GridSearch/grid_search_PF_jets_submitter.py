...
def sh_writer(shfileName_toRun, save_graphics, pt_flatten, path_to_pkl_folder, pklName, path_to_graphics_folder, path_to_model_folder, modelName):
    ...
    f.write(f"python3 grid_search_PF_jets.py -save_graphics {save_graphics} -pt_flatten {pt_flatten} -path_to_pkl_folder {path_to_pkl_folder} -pklName {pklName} -path_to_graphics_folder {path_to_graphics_folder} -path_to_model_folder {path_to_model_folder} -modelName {modelName}\n")
...
path_to_models          = "/eos/user/f/fsalerno/framework/MachineLearning/Grid_search_1/grid_search_models/PF_jets_boosted_LSTM"
save_graphics           = True
path_to_pkl_folder      = "/eos/user/f/fsalerno/framework/MachineLearning/Training_PF_2022_1_jets_20_boosted"
pklName                 = "trainingSet.pkl"
...
shfileName_toRun        = "GridSearch_base_1_PF_jets_boosted_LSTM"
path_to_graphics_folder = "/eos/user/f/fsalerno/framework/MachineLearning/Grid_search_1/graphics_gridsearch/PF_jets_boosted_LSTM"
path_to_model_folder    = "/eos/user/f/fsalerno/framework/MachineLearning/Grid_search_1/grid_search_models/PF_jets_boosted_LSTM"
