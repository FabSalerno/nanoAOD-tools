...
class trainer:
    ...
    def model_builder(self, InputShape_Jet, InputShape_FatJet, InputShape_PFC, InputShape_Top):
        ...
        print("Pre_slicing",PFC_inputs.shape)
        #Conv1D layer
        #z = PFC_inputs[:, :nPFCs, :]
        print("after slicing",PFC_inputs.shape)
        z = Conv1D(filters=32, kernel_size=3, activation='relu', padding='same')(PFC_inputs)
        ...
        #print("pre dense: ",x)
        x = Dense(4, activation ="relu", kernel_initializer="random_normal")(x)

        #print("post dense: ",x)
    

        outputs      = Dense(1, activation="sigmoid")(x) 
        #print("post out: ",outputs)
