...
if verbose:
    ...
    print(f"N. Top in category 3-0-0: {sum([len(dataset[c]['3j0fj'][0]) for c in components])}")
    ...
    print(f"N. Top in category 3-1-0: {sum([len(dataset[c]['3j1fj'][0]) for c in components])}")
    ...
    print(f"N. Top in category 2-1-0: {sum([len(dataset[c]['2j1fj'][0]) for c in components])}")
    ...
    print(f"N. Top in category 2-0-1: {sum([len(dataset[c]['1hvrj'][0]) for c in components])}")
    print(f"N. Top True:              {sum([len([i for i, x in enumerate(dataset[c]['1hvrj'][4]==1) if x==True]) for c in components])}")
    print(f"N. Top False:             {sum([len([i for i, x in enumerate(dataset[c]['1hvrj'][4]==0) if x==True]) for c in components])}")
    print("\n")
