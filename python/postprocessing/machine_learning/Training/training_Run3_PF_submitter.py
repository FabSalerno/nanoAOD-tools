...
doCut = False
cut = 0
#transformer, CNN, CNN_2D, CNN_2D_LSTM, LSTM
...
if phase == 1:
    training_set    = "/eos/user/f/fsalerno/framework/MachineLearning/Training_PF_2022_1_jets_20_boosted/trainingSet.pkl"
    model_path      = f"/eos/user/f/fsalerno/framework/MachineLearning/Training_PF_2022_1_jets_{nPFCs}_boosted_{model}_{cut}_pt_new/model.h5"
    outJson_path    = f"/eos/user/f/fsalerno/framework/MachineLearning/Training_PF_2022_1_jets_{nPFCs}_boosted_{model}_{cut}_pt_new/score_thresholds_{nPFCs}_{model}_{cut}_pt_new.json"
    graphics_path   = f"/eos/user/f/fsalerno/framework/MachineLearning/Training_PF_2022_1_jets_{nPFCs}_boosted_{model}_{cut}_pt_new/graphics"
elif phase == 2:
    training_set    = f"/eos/user/f/fsalerno/framework/MachineLearning/Training_PF_2022_2_jets_{nPFCs}_boosted_{model}_{cut}_pt/trainingSet.pkl"
    model_path      = f"/eos/user/f/fsalerno/framework/MachineLearning/Training_PF_2022_2_jets_{nPFCs}_boosted_{model}_{cut}_pt/model.h5"
    outJson_path    = f"/eos/user/f/fsalerno/framework/MachineLearning/Training_PF_2022_2_jets_{nPFCs}_boosted_{model}_{cut}_pt/score_thresholds_{nPFCs}_{model}_{cut}_pt.json"
    graphics_path   = f"/eos/user/f/fsalerno/framework/MachineLearning/Training_PF_2022_2_jets_{nPFCs}_boosted_{model}_{cut}_pt/graphics"
