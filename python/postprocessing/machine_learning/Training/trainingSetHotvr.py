...
if doLoop:
    ...
    for i in range(nev):
        ...
        for t in tops:
            ...
            if t.truth!=-1:
                ...
                elif best_top_category == 1: #3j0fj1hvrj
                ...
                elif best_top_category == 2: #3j0fj0hvrj
                    hvrj            = ROOT.TLorentzVector()
                    hvrj.SetPtEtaPhiM(0,0,0,0)
                    fj              = ROOT.TLorentzVector()
                    fj.SetPtEtaPhiM(0,0,0,0)
                ...
                elif best_top_category == 3: #2j1fj0hvrj
                    hvrj            = ROOT.TLorentzVector()
                    hvrj.SetPtEtaPhiM(0,0,0,0)
                    fj              = goodfatjets[t.idxFatJet]
                ...
                elif best_top_category == 4: #2j0fj1hvrj
                    hvrj            = goodhvrjets[t.idxHOTVRJet]
                    fj              = ROOT.TLorentzVector()
                    fj.SetPtEtaPhiM(0,0,0,0)
                    j0, j1          = goodjets[t.idxJet0], goodjets[t.idxJet1]
    ...
    for cat in categories:
        if "3j1fj0hvrj" in cat :
            n = 0
        elif "3j0fj1hvrj" in cat :
            n = 1
        elif "3j0fj0hvrj" in cat :
            n = 2
        elif "2j1fj0hvrj" in cat :
            n = 3
        elif "2j0fj1hvrj" in cat :
            n = 4
