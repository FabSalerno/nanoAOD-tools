...
usage = "python3 training_Run3_submitter.py"
...
phase               = 1
if phase == 1:
    training_set    = "/eos/user/f/fsalerno/framework/MachineLearning/Training_PF_2022_1_prova_TROTA_full/trainingSet.pkl"
    model_path      = "/eos/user/f/fsalerno/framework/MachineLearning/Training_PF_2022_1_prova_TROTA_full_300_pt/model.h5"
    outJson_path    = "/eos/user/f/fsalerno/framework/MachineLearning/Training_PF_2022_1_prova_TROTA_full_300_pt/score_thresholds.json"
    graphics_path   = "/eos/user/f/fsalerno/framework/MachineLearning/Training_PF_2022_1_prova_TROTA_full_300_pt/graphics"
elif phase == 2:
    training_set    = "/eos/user/f/fsalerno/framework/MachineLearning/Training_2018_2/trainingSet.pkl"
    model_path      = "/eos/user/f/fsalerno/framework/MachineLearning/Training_2018_2/model.h5"
    outJson_path    = "/eos/user/f/fsalerno/framework/MachineLearning/Training_2018_2/score_thresholds.json"
    graphics_path   = "/eos/user/f/fsalerno/framework/MachineLearning/Training_2018_2/graphics"
