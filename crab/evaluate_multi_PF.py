...
for c in components:
    ...
    for key in keys:
        # Scores
        h_score_top_mixed_true[key] = file_dict[c].Get(f"histograms_evaluation/score_top_mixed_true_{key}")
        h_score_top_mixed_false_other[key] = file_dict[c].Get(f"histograms_evaluation/score_top_mixed_false_other_{key}")
        h_score_top_mixed_false_QCD[key] = file_dict[c].Get(f"histograms_evaluation/score_top_mixed_false_qcd_{key}")
        h_score_top_mixed_false_all[key] = file_dict[c].Get(f"histograms_evaluation/score_top_mixed_false_all_{key}")
        h_score_top_mixed_true_cut_200_pt[key] = file_dict[c].Get(f"histograms_evaluation/score_top_mixed_true_cut_200_pt_{key}")
        h_score_top_mixed_false_other_cut_200_pt[key] = file_dict[c].Get(f"histograms_evaluation/score_top_mixed_false_other_cut_200_pt_{key}")
        h_score_top_mixed_false_QCD_cut_200_pt[key] = file_dict[c].Get(f"histograms_evaluation/score_top_mixed_false_qcd_cut_200_pt_{key}")
        h_score_top_mixed_false_all_cut_200_pt[key] = file_dict[c].Get(f"histograms_evaluation/score_top_mixed_false_all_cut_200_pt_{key}")
        h_score_top_mixed_true_cut_300_pt[key] = file_dict[c].Get(f"histograms_evaluation/score_top_mixed_true_cut_300_pt_{key}")
        h_score_top_mixed_false_other_cut_300_pt[key] = file_dict[c].Get(f"histograms_evaluation/score_top_mixed_false_other_cut_300_pt_{key}")
        h_score_top_mixed_false_QCD_cut_300_pt[key] = file_dict[c].Get(f"histograms_evaluation/score_top_mixed_false_qcd_cut_300_pt_{key}")
        h_score_top_mixed_false_all_cut_300_pt[key] = file_dict[c].Get(f"histograms_evaluation/score_top_mixed_false_all_cut_300_pt_{key}")
        h_score_3j1fj_true[key] = file_dict[c].Get(f"histograms_evaluation/score_3j1fj_true_{key}")
        h_score_3j0fj_true[key] = file_dict[c].Get(f"histograms_evaluation/score_3j0fj_true_{key}")
        h_score_2j1fj_true[key] = file_dict[c].Get(f"histograms_evaluation/score_2j1fj_true_{key}")
        h_score_3j1fj_false[key] = file_dict[c].Get(f"histograms_evaluation/score_3j1fj_false_{key}")
        h_score_3j0fj_false[key] = file_dict[c].Get(f"histograms_evaluation/score_3j0fj_false_{key}")
        h_score_2j1fj_false[key] = file_dict[c].Get(f"histograms_evaluation/score_2j1fj_false_{key}")

        # PT Top
        h_pt_top_mixed_true[key] = file_dict[c].Get(f"histograms_evaluation/pt_top_mixed_true_{key}")
        h_pt_top_mixed_false_other[key] = file_dict[c].Get(f"histograms_evaluation/pt_top_mixed_false_other_{key}")
        h_pt_top_mixed_false_QCD[key] = file_dict[c].Get(f"histograms_evaluation/pt_top_mixed_false_qcd_{key}")
        h_pt_top_mixed_false_all[key] = file_dict[c].Get(f"histograms_evaluation/pt_top_mixed_false_all_{key}")
        h_pt_5_100[key] = file_dict[c].Get(f"histograms_event_counter_5_per_100/pt_5_per_100_{key}")
        h_pt_1_100[key] = file_dict[c].Get(f"histograms_event_counter_1_per_100/pt_1_per_100_{key}")
        h_pt_1_1000[key] = file_dict[c].Get(f"histograms_event_counter_1_per_1000/pt_1_per_1000_{key}")

        # N Events
        h_event_counter_pre[key] = file_dict[c].Get(f"histograms_event_counter_pre/nevents_pre")
        h_event_counter_post[key] = file_dict[c].Get(f"histograms_event_counter_post/nevents_post")
        h_event_counter_5_100[key] = file_dict[c].Get(f"histograms_event_counter_5_per_100/nevents_5_per_100_{key}")
        h_event_counter_1_100[key] = file_dict[c].Get(f"histograms_event_counter_1_per_100/nevents_1_per_100_{key}")
        h_event_counter_1_1000[key] = file_dict[c].Get(f"histograms_event_counter_1_per_1000/nevents_1_per_1000_{key}")
        h_event_counter_5_100_cut_200_pt[key] = file_dict[c].Get(f"histograms_event_counter_5_per_100/nevents_5_per_100_cut_200_pt_{key}")
        h_event_counter_1_100_cut_200_pt[key] = file_dict[c].Get(f"histograms_event_counter_1_per_100/nevents_1_per_100_cut_200_pt_{key}")
        h_event_counter_1_1000_cut_200_pt[key] = file_dict[c].Get(f"histograms_event_counter_1_per_1000/nevents_1_per_1000_cut_200_pt_{key}")
        h_event_counter_5_100_cut_300_pt[key] = file_dict[c].Get(f"histograms_event_counter_5_per_100/nevents_5_per_100_cut_300_pt_{key}")
        h_event_counter_1_100_cut_300_pt[key] = file_dict[c].Get(f"histograms_event_counter_1_per_100/nevents_1_per_100_cut_300_pt_{key}")
        h_event_counter_1_1000_cut_300_pt[key] = file_dict[c].Get(f"histograms_event_counter_1_per_1000/nevents_1_per_1000_cut_300_pt_{key}")

        # MET
        h_MET_pre_all[key] = file_dict[c].Get(f"histograms_event_counter_pre/MET_pre")
        h_MET_post_all[key] = file_dict[c].Get(f"histograms_event_counter_post/MET_post")
        h_MET_5_100[key] = file_dict[c].Get(f"histograms_event_counter_5_per_100/MET_5_per_100_{key}")
        h_MET_1_100[key] = file_dict[c].Get(f"histograms_event_counter_1_per_100/MET_1_per_100_{key}")
        h_MET_1_1000[key] = file_dict[c].Get(f"histograms_event_counter_1_per_1000/MET_1_per_1000_{key}")

        # Mass Top
        h_mass_top_mixed_true[key] = file_dict[c].Get(f"histograms_evaluation/mass_top_mixed_true_{key}")
        h_mass_top_mixed_false_other[key] = file_dict[c].Get(f"histograms_evaluation/mass_top_mixed_false_other_{key}")
        h_mass_top_mixed_false_QCD[key] = file_dict[c].Get(f"histograms_evaluation/mass_top_mixed_false_qcd_{key}")
        h_mass_top_mixed_false_all[key] = file_dict[c].Get(f"histograms_evaluation/mass_top_mixed_false_all_{key}")
        h_mass_5_100[key] = file_dict[c].Get(f"histograms_event_counter_5_per_100/mass_5_per_100_{key}")
        h_mass_1_100[key] = file_dict[c].Get(f"histograms_event_counter_1_per_100/mass_1_per_100_{key}")
        h_mass_1_1000[key] = file_dict[c].Get(f"histograms_event_counter_1_per_1000/mass_1_per_1000_{key}")
